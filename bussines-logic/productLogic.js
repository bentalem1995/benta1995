...
async function getProductSales(){
   ...
   const qry = `SELECT ProductID as id, ProductName as name , UnitPrice as price , UnitsInStock as stock, ProductImage as image FROM products WHERE UnitsInStock >5`;
